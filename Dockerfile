...
RUN pip install -q opencv-python imageio imageio-ffmpeg ffmpeg-python av runpod \
    ...
    aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://huggingface.co/ckpt/FLUX.1-dev-Controlnet-Inpainting-Beta/resolve/main/diffusion_pytorch_model.safetensors -d /content/ComfyUI/models/controlnet -o FLUX.1-dev-Controlnet-Inpainting-Beta.safetensors
